...
(0, globals_1.describe)('US-1 : Créer un produit - E2E', function () {
    var container;
    var dataSource;
    var app;
    (0, globals_1.beforeAll)(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new postgresql_1.PostgreSqlContainer('postgres:16').withExposedPorts(5432).start()];
                case 1:
                    container = _a.sent();
                ...
                case 2:
                    _a.sent();
                    AppDataSource = require('../../../../config/db.config').default;
    ...
    (0, globals_1.test)('Scénario 1: création réussie', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, dataSource.getRepository(Product_1.Product).clear()];
                case 1:
                    // Étant donné qu'il n'y a pas de produit enregistré
                    _a.sent();
    ...
    (0, globals_1.test)('Scénario 2: création échouée - titre trop court', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                ...
                case 2:
                    ...
                    (0, globals_1.expect)(response.body.message).toBe('titre trop court');
                    return [4 /*yield*/, dataSource.getRepository(Product_1.Product).find()];
                case 3:
                    products = _a.sent();
                    (0, globals_1.expect)(products).toHaveLength(0);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, globals_1.test)('Scénario 3 : création échouée, prix négatif', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                ...
                case 2:
                    ...
                    (0, globals_1.expect)(response.status).toBe(400);
                    (0, globals_1.expect)(response.body.message).toBe('le prix doit être supérieur à 0');
                    return [4 /*yield*/, dataSource.getRepository(Product_1.Product).find()];
                case 3:
                    products = _a.sent();
                    (0, globals_1.expect)(products).toHaveLength(0);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    (0, globals_1.expect)(response.status).toBe(400);
                    (0, globals_1.expect)(response.body.message).toBe('le prix doit être inférieur à 10000');
                    return [4 /*yield*/, dataSource.getRepository(Product_1.Product).find()];
                case 3:
                    products = _a.sent();
                    (0, globals_1.expect)(products).toHaveLength(0);
